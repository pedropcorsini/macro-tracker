  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-8">
        ...
        {/* Abas login/cadastro */}
        <div className="flex mb-8 bg-[#0f0f0f] rounded-xl p-1">
          {[MODO.LOGIN, MODO.CADASTRO].map((m) => (
            ...
            >
              {m === MODO.LOGIN ? "Entrar" : "Criar conta"}
            </button>
          ))}
        </div>
        ...
        <div className="space-y-3 mb-4">
          <div>
            <label className="text-[10px] text-zinc-600 uppercase tracking-widest block mb-1.5">Email</label>
            <input
              type="email"
              value={email}
              ...
              className="w-full bg-[#0f0f0f] border border-[#2a2a2a] rounded-xl px-4 py-3 text-sm text-zinc-200 placeholder-zinc-700 outline-none focus:border-zinc-600 transition-all"
            />
          </div>
          <div>
            <label className="text-[10px] text-zinc-600 uppercase tracking-widest block mb-1.5">Senha</label>
            <input
              type="password"
              value={senha}
        ...
        >
          {carregando ? "Aguarde..." : modo === MODO.LOGIN ? "Entrar" : "Criar conta"}
        </button>

        {/* Divisor */}
        <div className="flex items-center gap-3 mb-6">
          <div className="flex-1 h-px bg-[#2a2a2a]" />
          <span className="text-[10px] text-zinc-700 uppercase tracking-widest">ou continue com</span>
          <div className="flex-1 h-px bg-[#2a2a2a]" />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 bg-[#0f0f0f] border border-[#2a2a2a] hover:border-zinc-600 rounded-xl py-2.5 text-xs text-zinc-400 hover:text-zinc-200 transition-all"
          >
