...
export default function Landing({ onLogin }) {
  ...
  const texts = {
    pt: {
      badge: "Painel de nutrição pessoal",
      ...
      feature_tag: "Controle diário",
      process_tag: "Rotina simples",
      stats_title: "Resumo nutricional",
    ...
    en: {
      badge: "Personal nutrition dashboard",
      ...
      feature_tag: "Daily control",
      process_tag: "Simple routine",
      stats_title: "Nutrition summary",
    ...
    es: {
      badge: "Panel de nutrición personal",
      ...
      feature_tag: "Control diario",
      process_tag: "Rutina simple",
      stats_title: "Resumen nutricional",
  ...
  const features = [
    { label: "Registro", color: "#8b5cf6", rgb: "139,92,246", title: { pt: "Registro de refeições", en: "Meal logging", es: "Registro de comidas" }, desc: { pt: "Café da manhã, almoço, lanche e jantar em um fluxo único.", en: "Breakfast, lunch, snack and dinner in one flow.", es: "Desayuno, almuerzo, merienda y cena en un solo flujo." } },
    { label: "Macros", color: "#10b981", rgb: "16,185,129", title: { pt: "Macros em tempo real", en: "Real-time macros", es: "Macros en tiempo real" }, desc: { pt: "Calorias, proteína, carbs e gordura atualizados a cada registro.", en: "Calories, protein, carbs and fat updated with each log.", es: "Calorías, proteína, carbos y grasa actualizados en cada registro." } },
    { label: "Água", color: "#3b82f6", rgb: "59,130,246", title: { pt: "Controle de hidratação", en: "Hydration tracking", es: "Control de hidratación" }, desc: { pt: "Copos visuais, entrada manual e metas personalizadas.", en: "Visual cups, manual input and custom goals.", es: "Vasos visuales, entrada manual y metas personalizadas." } },
    { label: "Evolução", color: "#f59e0b", rgb: "245,158,11", title: { pt: "Gráficos de evolução", en: "Progress charts", es: "Gráficos de evolución" }, desc: { pt: "Barras semanais e mensais com linhas de referência.", en: "Weekly and monthly bars with reference lines.", es: "Barras semanales y mensuales con líneas de referencia." } },
    { label: "Histórico", color: "#ef4444", rgb: "239,68,68", title: { pt: "Calendário de histórico", en: "History calendar", es: "Calendario de historial" }, desc: { pt: "Indicadores visuais de aderência diária e hidratação.", en: "Visual indicators for daily adherence and hydration.", es: "Indicadores visuales de adherencia diaria e hidratación." } },
    { label: "Nuvem", color: "#06b6d4", rgb: "6,182,212", title: { pt: "Nuvem e multi-idiomas", en: "Cloud & multi-language", es: "Nube y multi-idioma" }, desc: { pt: "Dados seguros com suporte em PT, EN e ES.", en: "Secure data with PT, EN and ES support.", es: "Datos seguros con soporte en PT, EN y ES." } },
  ]
  ...
  return (
    <div ref={rootRef} className="landing-root">
      ...
      <section className="hero" id="top">
        ...
        <div className="stats">
          <div className="stats-head">{tx.stats_title}</div>
          {[
        ...
        <div className="section-inner">
          ...
          <div className="feature-grid">
            {features.map((f, i) => (
              ...
              >
                <div className="feature-icon-wrap" style={{ background: `${f.color}18`, border: `1px solid ${f.color}30` }}>{f.label}</div>
