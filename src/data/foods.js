const foods = [
  ...
  { id: 9, name: "Ovo inteiro (cozido)", cal: 155, p: 13, c: 1.1, f: 11 },
  { id: 10, name: "Clara de ovo (cozida)", cal: 52, p: 11, c: 0.7, f: 0.2 },
  { id: 11, name: "Whey protein (pó)", cal: 400, p: 80, c: 8, f: 5 },
  { id: 12, name: "Linguiça toscana (grelhada)", cal: 280, p: 16, c: 2, f: 23 },
  { id: 13, name: "Peito de peru (fatiado)", cal: 109, p: 18, c: 3, f: 3 },
  ...
  { id: 23, name: "Pão francês", cal: 299, p: 9, c: 58, f: 3 },
  { id: 24, name: "Pão de forma integral (fatia)", cal: 247, p: 10, c: 41, f: 5 },
  ...
  // Frutas
  { id: 31, name: "Banana (prata)", cal: 98, p: 1.3, c: 26, f: 0.1 },
  { id: 32, name: "Banana (nanica)", cal: 89, p: 1.1, c: 23, f: 0.3 },
  { id: 33, name: "Maçã (com casca)", cal: 52, p: 0.3, c: 14, f: 0.2 },
  { id: 34, name: "Mamão papaia", cal: 43, p: 0.5, c: 11, f: 0.3 },
  { id: 35, name: "Manga (palmer)", cal: 65, p: 0.5, c: 17, f: 0.3 },
  { id: 36, name: "Abacaxi", cal: 50, p: 0.5, c: 13, f: 0.1 },
  { id: 37, name: "Laranja (pera)", cal: 47, p: 1, c: 11, f: 0.1 },
  { id: 38, name: "Melancia", cal: 30, p: 0.6, c: 8, f: 0.2 },
  { id: 39, name: "Uva (itália)", cal: 69, p: 0.6, c: 18, f: 0.4 },
  { id: 40, name: "Morango", cal: 32, p: 0.7, c: 7.7, f: 0.3 },
  { id: 41, name: "Abacate", cal: 160, p: 2, c: 9, f: 15 },
  { id: 42, name: "Goiaba", cal: 68, p: 2.6, c: 14, f: 1 },
  { id: 43, name: "Maracujá (polpa)", cal: 68, p: 2.4, c: 13, f: 1.7 },
  ...
  { id: 49, name: "Queijo mussarela", cal: 300, p: 22, c: 2.2, f: 22 },
  { id: 50, name: "Queijo cheddar", cal: 402, p: 25, c: 1.3, f: 33 },
  ...
  { id: 56, name: "Tomate (cru)", cal: 18, p: 0.9, c: 3.9, f: 0.2 },
  { id: 57, name: "Cenoura (cozida)", cal: 41, p: 0.9, c: 10, f: 0.2 },
  ...
  { id: 61, name: "Beterraba (cozida)", cal: 43, p: 1.6, c: 9.6, f: 0.2 },
  ...
  { id: 67, name: "Amêndoas", cal: 579, p: 21, c: 22, f: 50 },
  { id: 68, name: "Castanha-do-pará", cal: 659, p: 14, c: 12, f: 67 },
  { id: 69, name: "Castanha de caju (torrada)", cal: 574, p: 15, c: 33, f: 46 },
