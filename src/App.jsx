      ...
      <div className="min-h-screen bg-gray-50 dark:bg-[#0f0f0f] transition-colors">
        <div className="border-b border-gray-200 dark:border-[#2a2a2a] bg-white dark:bg-[#0f0f0f]">
          <div className="max-w-5xl mx-auto px-4 pt-6 pb-0">
            {/* Linha superior: botões nas pontas, título no centro */}
            <div className="grid grid-cols-3 items-center mb-1">
              {/* Esquerda — toggle tema */}
              ...
              <div className="flex flex-col items-center">
                <div className="flex items-center gap-2">
                  ...
                  <h1
                    ...
                    className="text-sm sm:text-base tracking-widest text-gray-900 dark:text-white uppercase"
                  >
                    Macro Tracker
                  </h1>
                ...
                <p className="text-[9px] text-gray-400 dark:text-zinc-600 tracking-widest mt-0.5">
            ...
            {/* Abas */}
            <div className="flex gap-0 w-full justify-center mt-3">
              {ABAS.map((aba) => (
                <button
                  key={aba.id}
