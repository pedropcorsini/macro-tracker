      ...
      <div className="app-shell h-screen flex overflow-hidden transition-colors">
        ...
        `}>
          ...
          <div className="app-sidebar-brand px-5 pt-7 pb-6 border-b border-gray-100 dark:border-[#2a2a2a] flex-shrink-0 relative">
            ...
            <h1 style={{ fontFamily: "'Space Grotesk', sans-serif" }} className="text-sm tracking-widest text-gray-900 dark:text-white uppercase leading-tight">
              Macro<br />Tracker
            </h1>
          ...
          <nav className="app-sidebar-nav flex-1 min-h-0 px-3 py-4 space-y-1">
            {ABAS.map((aba) => (
              <button
                ...
                className={`app-nav-item w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all ${
                  abaAtiva === aba.id
                    ? "is-active bg-violet-50 dark:bg-violet-500/10 text-violet-600 dark:text-violet-400 font-medium"
          ...
          <div className="app-sidebar-footer px-3 pb-5 space-y-1 border-t border-gray-100 dark:border-[#2a2a2a] pt-3 flex-shrink-0">
            ...
            <button
              ...
              aria-pressed={isDark}
              className="app-sidebar-action w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-gray-400 dark:text-zinc-500 hover:bg-gray-50 dark:hover:bg-[#1a1a1a] hover:text-gray-700 dark:hover:text-zinc-300 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isDark ? (
            ...
            <button
              onClick={sair}
              className="app-sidebar-action w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-gray-400 dark:text-zinc-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 hover:text-rose-500 transition-all"
            >
        ...
        <div className="app-main flex-1 min-w-0 flex flex-col h-screen overflow-hidden">
          ...
          <div className="app-mobile-header lg:hidden flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-[#2a2a2a] flex-shrink-0">
            ...
            <h1 style={{ fontFamily: "'Space Grotesk', sans-serif" }} className="text-sm tracking-widest text-gray-900 dark:text-white uppercase">
              Macro Tracker
            </h1>
            <button
              onClick={alternarTema}
